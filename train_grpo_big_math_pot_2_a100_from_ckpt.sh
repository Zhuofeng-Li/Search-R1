...
export BASE_MODEL='verl_checkpoints/pot-r1-grpo-qwen2.5-1.5b-Instruct/actor/global_step_60'
export EXPERIMENT_NAME=pot-r1-grpo-qwen2.5-1.5b-Instruct-ckpt-step-60 # set diff name for different ckpt
